          ...
          >
            ...
            <Tbody>
              <Tr>
                ...
                <Td px={["4", "4","6"]}>
                  <Box>
                    <Text fontWeight="bold">Eronar Alves</Text>
                    <Text fontSize="sm" color="gray.300">alveseronar@gmail.com</Text>
                  </Box>
                </Td>
                {isWideVersion && (
                  <Td>27 de maio de 2022</Td>
                )}
              </Tr>
              <Tr>
                <Td px={["4", "4","6"]}>
                ...
                <Td px={["4", "4","6"]}>
                  <Box>
                    <Text fontWeight="bold">Jonas Bezerra</Text>
                    <Text fontSize="sm" color="gray.300">jonaasalves@gmail.com</Text>
                  </Box>
                </Td>
                {isWideVersion && (
                  <Td>27 de maio de 2022</Td>
